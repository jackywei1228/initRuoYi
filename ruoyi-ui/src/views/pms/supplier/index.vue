<template>
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['pms:supplier:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
    ...
    <el-table v-loading="loading" :data="supplierList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="供货周期(天)" align="center" prop="deliveryCycle" width="100" />
        ...
        <el-row>
          ...
          <el-col :span="12">
            <el-form-item label="供货周期" prop="deliveryCycle">
              <el-input-number v-model="form.deliveryCycle" :min="0" :max="365" placeholder="天数" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
...
<script>
import { listSupplier, getSupplier, delSupplier, addSupplier, updateSupplier } from "@/api/pms/supplier"
...
export default {
  ...
  methods: {
    ...
    handleStatusChange(row) {
      ...
      this.$modal.confirm('确认要"' + text + '""' + row.supplierName + '"供应商吗？').then(function() {
        return updateSupplier({ supplierId: row.supplierId, status: row.status })
      }).then(() => {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('pms/supplier/export', {
        ...this.queryParams
