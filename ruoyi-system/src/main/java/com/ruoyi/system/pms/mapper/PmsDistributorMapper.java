 ...
 * @author ruoyi
 */
public interface PmsDistributorMapper
{
    /**
     * 查询经销商
     *
     ...
     * @return 经销商集合
     */
    public List<PmsDistributor> selectByLevelId(Long levelId);
     ...
     * @return 结果
     */
    public PmsDistributor checkCompanyNameUnique(String companyName);
}